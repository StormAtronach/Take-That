...
local function registerModConfig()
    ...
    page:createOnOffButton{
        label = "NPC Reactions: also use block/parry animations",
    ...
    balancing:createOnOffButton{
        ...
        description = "Enable Hit Chance Multiplier for NPC and creature's attacks. As before, the parry mechanic reduces the DPS, potentially slowing down combat. This helps make each hit count, resulting in more impactful combat.",
...
--[[
    ...
    spellBattingSettings:createOnOffButton{
